...
public class Valkyrie : BaseUnit {
	...
	void Update () {
		...
		float aggroRange = 21f;//Valkyrie will try to attack enemies at 20 feet
		//iterates through array of enemies
		float closestEnemyDist = 21; //max distance of Valkyrie is 20 feet
	...
	protected override void Attack(GameObject enemy, float enemyDist)
	{
		...
		float attackRange = 10f; //attack range for valkyrie
